...
class model_with_norm():
    ...
    def update_grad(self, learning_rate, batch_size):
        ...
        self.norm2 = self.optimizer.update_grad('norm2',self.norm2, learning_rate/batch_size,True)
        self.norm1 = self.optimizer.update_grad('norm1',self.norm1, learning_rate/batch_size,True)
